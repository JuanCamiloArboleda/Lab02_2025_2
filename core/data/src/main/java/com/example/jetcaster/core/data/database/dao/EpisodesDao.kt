...
abstract class EpisodesDao : BaseDao<Episode> {
    ...
    // ✅ Guarda la última posición del episodio
    @Query("UPDATE episodes SET last_position_ms = :position WHERE uri = :episodeUri")
    abstract suspend fun updatePlaybackPosition(episodeUri: String, position: Long)
}