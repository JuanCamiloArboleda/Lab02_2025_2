...
data class Episode(
    ...
    @ColumnInfo(name = "is_played") val isPlayed: Boolean = false,

    // ✅ Posición donde el usuario dejó de escuchar
    @ColumnInfo(name = "last_position_ms") val lastPositionMs: Long = 0L,
)
