...
object DataDiModule {
    ...
    @Provides
    @Singleton
    fun providePodcastCategoryEntryDao(database: JetcasterDatabase): PodcastCategoryEntryDao =
        database.podcastCategoryEntryDao()
    ...
    @Provides
    @Singleton
    fun providePodcastFollowedEntryDao(database: JetcasterDatabase): PodcastFollowedEntryDao =
